...
class TaskStatus:
    ...
    def get_next_status(cls, current_status: str) -> str | None:
        ...
        next_status_map: dict[str, str | None] = {
...
class FileType:
    ...
    SPREADSHEET = "spreadsheet"  # Spreadsheet file
...
# System settings
SYSTEM_USER_ID = 1  # System user for automated actions
ADMIN_USER_ID = 2  # Default admin user
